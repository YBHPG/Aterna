...
- Добавлены DTO и безопасные эндпоинты для обновления электронной почты (`UpdateEmailDto`) и пароля (`UpdatePasswordDto`).
...
- **Профиль:** Добавлена страница `/profile` с формами для обновления email и пароля, а также кнопкой выхода из аккаунта.
