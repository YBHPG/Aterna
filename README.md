...
- **Редактирование (`PATCH /messages/:id`):** Возможность редактировать текст письма строго в первые 24 часа после его создания и только в статусе `pending`.
...
- **Профиль:** Добавлена страница `/profile` с формами для обновления имени, email и пароля, а также смарт-кнопками интеграций.
...
| Frontend: Dark Mode & Toast Animations | Ready  |
